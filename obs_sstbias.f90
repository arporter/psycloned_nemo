MODULE obs_sstbias
  ...
  SUBROUTINE obs_app_sstbias(sstdata, k2dint, knumtypes, cl_bias_files)
    ...
    CALL ProfileStart('obs_app_sstbias', 'r0', psy_profile0)
    ...
    DO jtype = 1, knumtypes
      CALL ProfileStart('obs_app_sstbias', 'r1', psy_profile1)
      numsstbias = 0
      ...
      IF (numsstbias > 0) THEN
        CALL ProfileStart('obs_app_sstbias', 'r2', psy_profile2)
      ...
      END IF
    END DO
    CALL ProfileStart('obs_app_sstbias', 'r3', psy_profile3)
    ...
    DO jtype = 1, knumtypes
      CALL ProfileStart('obs_app_sstbias', 'r4', psy_profile4)
      ...
      DO jobs = 1, sstdata % nsurf
        ...
        END IF
      END DO
      CALL ProfileStart('obs_app_sstbias', 'r5', psy_profile5)
    ...
    END DO
    CALL ProfileStart('obs_app_sstbias', 'r6', psy_profile6)
