...
&(vb(ji, jj, jk) * r1_e1v(ji, jj) - vb(ji, jj - 1, jk) * r1_e1v(ji, jj - 1)) * r1_e2t(ji, jj) * e1t(ji, jj)) * tmask(ji, jj, jk)
...
&(vb(ji + 1, jj, jk) * r1_e2v(ji + 1, jj) - vb(ji, jj, jk) * r1_e2v(ji, jj)) * r1_e1f(ji, jj) * e2f(ji, jj)) * fmask(ji, jj, jk)
          ...
          DO jj = 2, jpjm1
            DO ji = 2, jpim1
              ...
              ahmt(ji, jj, jk) = zdelta * SQRT(dtensq(ji, jj) + r1_4 * (dshesq(ji, jj) + dshesq(ji, jj - 1) + dshesq(ji - 1, jj) + &
&dshesq(ji - 1, jj - 1)))
              ...
              ahmf(ji, jj, jk) = zdelta * SQRT(dshesq(ji, jj) + r1_4 * (dtensq(ji, jj) + dtensq(ji, jj + 1) + dtensq(ji + 1, jj) + &
&dtensq(ji + 1, jj + 1)))
